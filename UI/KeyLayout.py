...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(400, 90, 271, 176))
        ...
        self.comboBox_3.setGeometry(QtCore.QRect(500, 20, 111, 28))
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(250, 60, 144, 264))
        ...
        self.label_fun1 = QtWidgets.QLabel(self.layoutWidget_2)
        self.label_fun1.setObjectName("label_fun1")
        self.verticalLayout_4.addWidget(self.label_fun1)
        self.label_fun2 = QtWidgets.QLabel(self.layoutWidget_2)
        self.label_fun2.setObjectName("label_fun2")
        self.verticalLayout_4.addWidget(self.label_fun2)
        self.label_fun3 = QtWidgets.QLabel(self.layoutWidget_2)
        self.label_fun3.setObjectName("label_fun3")
        self.verticalLayout_4.addWidget(self.label_fun3)
        self.label_fun4 = QtWidgets.QLabel(self.layoutWidget_2)
        self.label_fun4.setObjectName("label_fun4")
        self.verticalLayout_4.addWidget(self.label_fun4)
        self.label_fun5 = QtWidgets.QLabel(self.layoutWidget_2)
        self.label_fun5.setObjectName("label_fun5")
        self.verticalLayout_4.addWidget(self.label_fun5)
        self.horizontalLayout_3.addLayout(self.verticalLayout_4)
        self.verticalLayout_5 = QtWidgets.QVBoxLayout()
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.lineEdit_fun1 = QtWidgets.QLineEdit(self.layoutWidget_2)
        self.lineEdit_fun1.setObjectName("lineEdit_fun1")
        self.verticalLayout_5.addWidget(self.lineEdit_fun1)
        self.lineEdit_fun2 = QtWidgets.QLineEdit(self.layoutWidget_2)
        self.lineEdit_fun2.setObjectName("lineEdit_fun2")
        self.verticalLayout_5.addWidget(self.lineEdit_fun2)
        self.lineEdit_fun3 = QtWidgets.QLineEdit(self.layoutWidget_2)
        self.lineEdit_fun3.setObjectName("lineEdit_fun3")
        self.verticalLayout_5.addWidget(self.lineEdit_fun3)
        self.lineEdit_fun4 = QtWidgets.QLineEdit(self.layoutWidget_2)
        self.lineEdit_fun4.setObjectName("lineEdit_fun4")
        self.verticalLayout_5.addWidget(self.lineEdit_fun4)
        self.lineEdit_fun5 = QtWidgets.QLineEdit(self.layoutWidget_2)
        self.lineEdit_fun5.setObjectName("lineEdit_fun5")
        self.verticalLayout_5.addWidget(self.lineEdit_fun5)
